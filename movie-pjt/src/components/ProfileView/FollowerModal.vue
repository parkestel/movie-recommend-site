...
.modal-content {
    ...
    padding: 25px 20px 25px 25px;  /* 오른쪽 패딩 조정 */
    width: 300px;
    max-height: 400px;
    border-radius: 15px;  /* 25px에서 15px로 수정 */
    position: relative;
